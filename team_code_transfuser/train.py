...
def main():
    ...
    parser.add_argument('--root_dir', type=str, default=r'/data/', help='Root directory of your training data')
    ...
    # else:
    # train_set = Subset(train_set, range(0, int(len(train_set)*0.4)))
    # val_set = Subset(val_set, range(0, int(len(train_set)*0.4)))
